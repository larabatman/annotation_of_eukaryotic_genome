...
# Input files
#-------------------------------------------------
res_dir <- "/data/users/lland/annotation_of_eukaryotic_genome/EDTA_annotation/istisu1.bp.p_ctg.fa.LTR_analysis"
gff_file <- file.path(res_dir, "genomic.fna.mod.LTR.intact.raw.gff3")
cls_file <- file.path(res_dir, "genomic.fna.mod.LTR.raw.fa.rexdb-plant.cls.tsv")
...
ggsave(file.path(plot_dir, "01_LTR_Copia_Gypsy_cladelevel.png"), combined, width=12, height=10, dpi=300)
ggsave(file.path(plot_dir, "01_LTR_Copia_Gypsy_cladelevel.pdf"), combined, width=12, height=10)
